...
# ---------- Flow A: Twilio Media Stream ↔ OpenAI Realtime (modularized) ----------
from flow_a import register_flow_a

register_flow_a(
    app=app,
    logger=logger,
    call_fsm_router=call_fsm_router,
    settings={
        "OPENAI_REALTIME_URL": OPENAI_REALTIME_URL,
        "OPENAI_REALTIME_HEADERS": OPENAI_REALTIME_HEADERS,
        "REALTIME_SYSTEM_PROMPT": REALTIME_SYSTEM_PROMPT,
        "VOICE_NAME": VOICE_NAME,
        "BYTES_PER_FRAME": BYTES_PER_FRAME,
        "FRAME_INTERVAL": FRAME_INTERVAL,
        "PREBUFFER_BYTES": PREBUFFER_BYTES,
        "MAX_TWILIO_BACKLOG_SECONDS": MAX_TWILIO_BACKLOG_SECONDS,
    },
)
